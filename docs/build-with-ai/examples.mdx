...
ticker, a rotating fact, a countdown, a scoreboard. Below is the one-line prompt you'd
send for each (right after the [cheat-sheet](/docs/build-with-ai)), the result, and the
one lesson that app teaches about steering the AI.

Every render below came from a prompt plus the cheat-sheet, then a quick preview to catch
the AI's usual slip-ups, collected at the [bottom of the page](#the-mistakes-to-head-off).
...
1. Paste the [cheat-sheet](/docs/build-with-ai).

...
<figure className="figure">
  <LedImage className="led led--glow" src="/img/apps/ported-bigclock/main.png" alt="A large digital clock" width="300" />
</figure>
...
<figure className="figure">
  <LedImage className="led led--glow" src="/img/apps/ported-weather/main.png" alt="A weather panel showing a city and temperature" width="300" />
</figure>
...
<figure className="figure">
  <LedImage className="led led--glow" src="/img/examples/btc.png" alt="A Bitcoin price ticker" width="300" />
</figure>
...
<figure className="figure">
  <LedImage className="led led--glow" src="/img/apps/ported-catfact/main.png" alt="A fact panel with a small icon and wrapped text" width="300" />
</figure>
...
<figure className="figure">
  <LedImage className="led led--glow" src="/img/apps/countdown/days.png" alt="A days-remaining countdown" width="300" />
</figure>
...
<figure className="figure">
  <LedImage className="led led--glow" src="/img/examples/ai-score.png" alt="A two-team scoreboard" width="300" />
</figure>
